...
/**
 * Created by THANYANI on 2017/08/21.
 */

public class VTour extends RecyclerView.Adapter<VTour.ViewHolder> {

    Context context;
    List<VendaTour> vendaTours;

    public VTour(Context context, List<VendaTour> vendaTours) {
        this.context = context;
        this.vendaTours = vendaTours;
    }

    @Override
    public VTour.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(VTour.ViewHolder holder, int position) {
